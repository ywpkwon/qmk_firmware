...
#define KC_NAVIA LT(_LAYER5, KC_A)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
		[_LAYER0] = LAYOUT( /* Base */
		  ...
		  CTL_T(KC_ESC),      KC_NAVIA, KC_S,     KC_D,  KC_F,  KC_G,  KC_H,  KC_J,  KC_K,    KC_L,    LT(5, KC_SCLN),    KC_QUOT,           CTL_T(KC_ENT), \
		  KC_LSFT,            KC_Z,     KC_X,     KC_C,  KC_V,  KC_B,  KC_N,  KC_M,  KC_COMM, KC_DOT,  RSFT_T(KC_SLSH),   KC_UP,             LT(2, KC_DEL),\
		  LT(1, KC_ENT),      MO(1),    KC_LALT,                KC_SPC,              KC_LANG1,MO(1),   KC_LEFT,           KC_DOWN,           KC_RIGHT),
		[_LAYER1] = LAYOUT( /* FN */
		  TO(3),    KC_F1,    KC_F2,    KC_F3,    KC_F4,    KC_F5,    KC_F6,    KC_F7,    KC_F8,    KC_F9,    KC_F10,   KC_F11,   KC_F12,   KC_DEL ,\
		  TO(4),    _______,  KC_UP,    _______,  _______,  _______,  _______,  _______,  KC_INS,   _______,  KC_PSCR,  KC_SLCK,  KC_PAUS,  _______,\
		  _______,  KC_LEFT,  KC_DOWN,  KC_RIGHT, _______,  _______,  _______,  _______,  _______,  _______,  KC_HOME,  KC_PGUP,            _______,\
		  TO(0),    _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  KC_END,   KC_PGDOWN,KC_VOLU,            KC_MUTE,\
			_______,  _______,  _______,                      KC_BSPC,                      _______,  _______,  KC_MPRV,  KC_VOLD,            KC_MNXT),
		...
		[_LAYER4] = LAYOUT( /* SWITCH LALT AND LGUI */
			KC_GRV,         KC_1,     KC_2,     KC_3,  KC_4,  KC_5,  KC_6,    KC_7,  KC_8,    KC_9,     KC_0,            KC_MINS,  KC_EQL,  KC_BSPC,\
		  KC_TAB,         KC_Q,     KC_W,     KC_E,  KC_R,  KC_T,  KC_Y,    KC_U,  KC_I,    KC_O,     KC_P,            KC_LBRC,  KC_RBRC, KC_BSLASH,\
			CTL_T(KC_ESC),  KC_A,     KC_S,     KC_D,  KC_F,  KC_G,  KC_H,    KC_J,  KC_K,    KC_L,     LT(5, KC_SCLN),  KC_QUOT,           KC_ENT, \
		  KC_LSFT,        KC_Z,     KC_X,     KC_C,  KC_V,  KC_B,  KC_N,    KC_M,  KC_COMM, KC_DOT,   RSFT_T(KC_SLSH), KC_UP,             LT(2, KC_DEL),\
			LT(1, KC_ENT),  KC_LGUI,  KC_LALT,                KC_SPC,                KC_RALT, MO(1),    KC_LEFT,         KC_DOWN,           KC_RIGHT),
    [_LAYER5] = LAYOUT( /* NAVI */
      KC_GESC,        _______,  _______,  _______, _______, _______,  _______, _______, _______, _______, _______,  _______,  _______,  _______,\
      _______,        _______,  KC_BTN1,  KC_MS_U, KC_BTN2, KC_WH_U,  KC_PGUP, KC_HOME, KC_UP,   KC_END,  _______,  _______,  _______,  _______,\
      _______,        _______,  KC_MS_L,  KC_MS_D, KC_MS_R, KC_WH_D,  KC_PGDN, KC_LEFT, KC_DOWN, KC_RGHT, _______,  _______,            _______, \
