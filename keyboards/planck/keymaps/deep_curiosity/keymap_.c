...
[_QWERTY] = LAYOUT_planck_grid(
    ...
    NAVI, KC_LGUI,  KC_LCTL,   KC_LALT, NUMERIC,   KC_SPC,  KC_SPC,  SYMBOLIC,   KC_LALT, KC_RCTL, KC_RGUI, LT(_NAVI, KC_ENT)
),
#else
...
[_NUMERIC] = LAYOUT_planck_grid(
    ...
    ___,  ___,  ___,  ___,  ___,  KC_BSPC,  KC_BSPC,  ___,  ___,  ___,  ___,  ___
),
#else
...
// [_ADJUST] = LAYOUT_planck_grid(
//     ___, RESET,   DEBUG,   RGB_TOG, RGB_MOD, RGB_HUI, RGB_HUD, RGB_SAI, RGB_SAD,  RGB_VAI, RGB_VAD, KC_DEL ,
//     ___, ___, MU_MOD,  AU_ON,   AU_OFF,  AG_NORM, AG_SWAP, QWERTY,  COLEMAK,  DVORAK,  PLOVER,  ___,
//     ___, MUV_DE,  MUV_IN,  MU_ON,   MU_OFF,  MI_ON,   MI_OFF,  TERM_ON, TERM_OFF, ___, ___, ___,
//     ___, ___, ___, ___, ___, ___, ___, ___, ___,  ___, ___, ___
// )
