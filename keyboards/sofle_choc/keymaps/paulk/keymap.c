...
[_BASIC] = LAYOUT(  /* Base */
   ...
   CTL_T(KC_ESC), KC_A,   KC_S,    KC_D,    KC_F,    KC_G,                       KC_H,     KC_J,     KC_K,    KC_L,    LT(_RAISE, KC_SCLN), CTL_T(KC_ENT),
...
[_RAISE] = LAYOUT(
        ...
        XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                   KC_LEFT, KC_DOWN,   KC_UP, KC_RGHT, _______, XXXXXXX,
